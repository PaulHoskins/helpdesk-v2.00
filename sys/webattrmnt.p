...
DEFINE BUFFER b-valid FOR webattr.
DEFINE BUFFER b-table FOR webattr.
...
DEFINE VARIABLE lc-systemid     AS CHARACTER NO-UNDO.
DEFINE VARIABLE lc-attrid       AS CHARACTER NO-UNDO.
DEFINE VARIABLE lc-attrvalue    AS CHARACTER NO-UNDO.
DEFINE VARIABLE lc-note         AS CHARACTER NO-UNDO.
DEFINE VARIABLE lc-HTMFormat    AS CHARACTER NO-UNDO.
...
------------------------------------------------------------------------------*/
    ...
    ASSIGN 
        lc-title = lc-title + ' Web Attribute'
    ...
    DO:
        ...
        DO:
            ASSIGN 
                lc-systemid  = get-value("systemid")
            ...
            DO:
                ...
                DO:
                    CREATE b-table.
                    ASSIGN 
                        b-table.SystemID = CAPS(lc-systemid)
                ...
                DO:
                    ASSIGN 
                        b-table.attrvalue = lc-attrvalue
