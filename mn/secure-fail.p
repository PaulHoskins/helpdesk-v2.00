...
PROCEDURE process-web-request :
    ...
    '<h2>You do not have access to the page requested using the link supplied ' get-user-field("linkinfo") 
    
    '<br/>The link has expired or does not exist</h2>'
