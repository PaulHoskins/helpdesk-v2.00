/***********************************************************************
    ...
    Program:        crm/addnote.p
    
    Purpose:        Add Note To CRM Op
    
    Notes:
    
    
    When        Who         What
    22/08/2016  phoski      CompanyCode      
***********************************************************************/
CREATE WIDGET-POOL.
...
------------------------------------------------------------------------------*/
    ...
    FIND b-op_master WHERE ROWID(b-op_master) = to-rowid(lc-rowid) NO-LOCK NO-ERROR.
    ...
    DO:
        ...
        DO:
            CREATE b-table.
            ASSIGN 
                b-table.op_id      = b-op_master.op_id
                b-table.CompanyCode = b-op_master.CompanyCode
    ...
    {&out} htmlib-StartForm("mainform","post", appurl + '/crm/addnote.p' ) skip.
