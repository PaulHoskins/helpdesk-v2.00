...
DEFINE BUFFER b-query  FOR crm_data_load.
DEFINE BUFFER b-search FOR crm_data_load.
...
PROCEDURE process-web-request :
    ...
    */
    ...
    {&out}
    htmlib-TableHeading(
        "Description^left|Created By^left|On|Records^right"
        ) skip.
    ...
    REPEAT WHILE AVAILABLE b-query:
        ...
        {&out}
            ...
            htmlib-MntTableField(html-encode(com-userName(b-query.loginid)),'left')
            htmlib-MntTableField(string(b-query.created,"99/99/9999 HH:MM"),'left')
