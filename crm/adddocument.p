...
PROCEDURE process-web-request :
    ...
    CASE lc-type:
        ...
        WHEN "CRMOP" THEN
            DO:
                ...
                IF AVAILABLE op_master
                    THEN ASSIGN lc-title = lc-title + " Opportunity " + string(op_master.descr).
                ASSIGN 
    ...
    {&out} htmlib-Hidden("OKPage", appurl + '/crm/adddocumentok.p?type=' + lc-type
        + "&rowid=" + lc-rowid).
