/***********************************************************************
    ...
    Program:        crm/ajax/delaction.p
    
    Purpose:        Delete CRM action 
...
PROCEDURE process-web-request :
    ...
    FIND op_Action WHERE op_Action.opActionID = int(lc-rowid) EXCLUSIVE-LOCK NO-ERROR.
    IF AVAILABLE op_Action THEN
    DO:
       
        FOR EACH op_Activity EXCLUSIVE-LOCK
